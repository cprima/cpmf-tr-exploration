...
**Device**: Raumfeld Speaker (1st gen, external antenna)  
**Source**: <https://updates.raumfeld.com/repair/speaker.img>  
...
- `_speaker.img.extracted/com.raumfeld.hardwared.conf`
- `_speaker.img.extracted/dropbear`
- `_speaker.img.extracted/raumfeld-version`
